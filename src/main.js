...
manager.onLoad = function () {
  loadingScreenButton.style.border = "8px solid #a53d52";
  loadingScreenButton.style.background = "#c75a6d";
  loadingScreenButton.style.color = "#e6dede";
  loadingScreenButton.style.boxShadow = "rgba(0, 0, 0, 0.24) 0px 3px 8px";
  loadingScreenButton.textContent = "Ingresar!";
  ...
  function handleEnter() {
    ...
    loadingScreenButton.style.border = "8px solid #e06c9f";
    loadingScreenButton.style.background = "#f8c6d8";
    loadingScreenButton.style.color = "#e06c9f";
    loadingScreenButton.style.boxShadow = "none";
    loadingScreenButton.textContent = "~ Bienvenido ~";    
    loadingScreen.style.background = "#f8c6d8";
...
const socialLinks = {
  ...
  YouTube: "https://www.youtube.com/watch?v=7Fncun4ObQk",
  Twitter: "https://x.com/erika_meeow",
};
